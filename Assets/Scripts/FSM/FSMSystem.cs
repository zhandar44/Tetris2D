...
/// Method Act has the code to perform the actions the NPC is supposed do if it's on this state.
/// </summary>
//FSM状态类，使用字典存储状态转换条件及状态
//方法：为字典添加状态，删除字典状态，返回字典状态，进入前执行，离开前执行，行动
public abstract class FSMState:MonoBehaviour
{
    protected Control ctrl;
    public Control CTRL { set { ctrl = value; } }
...
public class FSMSystem
{
    ...
    /// </summary>
    public void AddState(FSMState s,Control ctrl)
    {
        ...
        s.FSM = this;         //设置当前状态的FSMSystem用于访问方法
        s.CTRL = ctrl;         //当前状态可访问控制层
        ...
        //判断插入列表的状态是否存在，states为状态列表，s为要插入的状态
